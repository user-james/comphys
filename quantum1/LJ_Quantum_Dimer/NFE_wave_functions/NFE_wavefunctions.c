...
int main(int argc, char** argv )
{
    ...
    // modified piece of code to allow it to be called with arguments from Python code
    if(argc != 3){
        printf("Incorrect number of arguments, taking default potential values\n");                                                      
    }
    else{
...
int plot(double V1, double V2) 
{
    ...
    fprintf(pipe, "set output 'NFE_band_structure.pdf'\n"); 
